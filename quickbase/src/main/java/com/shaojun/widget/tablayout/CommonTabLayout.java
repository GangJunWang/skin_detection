package com.shaojun.widget.tablayout;
...
import com.shaojun.quickbase.R;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void addTab(final int position, View tabView) {
        ...
        Typeface face = Typeface.createFromAsset(tabView.getContext().getAssets(),"fonts/lantinghei.ttf");
        tv_tab_title.setTypeface(face);
