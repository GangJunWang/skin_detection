...
package com.zizhu.skindetection.common.widget.swipeback;
...
public class ViewDragHelper {
     ...
     * and draggability of item_expand_listview_child views.
     */
    public static abstract class Callback {
        ...
        /**
         * Called when a item_expand_listview_child view is captured for dragging or settling. The ID
         * of the pointer currently dragging the captured view is supplied. If
         * activePointerId is identified as {@link #INVALID_POINTER} the layout_zxing_capture
         * is programmatic instead of pointer-initiated.
         * 
         * @param capturedChild Child view that was captured
         * @param activePointerId Pointer id tracking the item_expand_listview_child layout_zxing_capture
         */
        public void onViewCaptured(View capturedChild, int activePointerId) {
        }

        /**
         * Called when the item_expand_listview_child view is no longer being actively dragged. The
         ...
         * {@link #STATE_SETTLING} and the view layout_zxing_capture will not fully end until
         ...
         * </p>
         * 
         * @param releasedChild The captured item_expand_listview_child view now being released
         ...
         * touched by the user while no item_expand_listview_child view is currently captured.
         * 
         ...
         * the subscribed edges in the parent view while no item_expand_listview_child view is
         * currently captured.
         * 
         * @param edgeFlags A combination of edge flags describing the edge(s)
         *            dragged
        ...
        /**
         * Called to determine the Z-order of item_expand_listview_child views.
         * 
        ...
        /**
         * Return the magnitude of a draggable item_expand_listview_child view's horizontal range of
        ...
        /**
         * Return the magnitude of a draggable item_expand_listview_child view's vertical range of
         * motion in pixels. This method should return 0 for views that cannot
         * move vertically.
         * 
         * @param child Child view to check
        ...
        /**
         * Called when the user's input indicates that they want to layout_zxing_capture the
         * given item_expand_listview_child view with the pointer indicated by pointerId. The
         ...
         * layout_zxing_capture is successful.
         * </p>
         * 
         * @param child Child the user is attempting to layout_zxing_capture
         * @param pointerId ID of the pointer attempting the layout_zxing_capture
         * @return true if layout_zxing_capture should be allowed, false otherwise
         */
        public abstract boolean tryCaptureView(View child, int pointerId);

        /**
         * Restrict the motion of the dragged item_expand_listview_child view along the horizontal
        ...
        /**
         * Restrict the motion of the dragged item_expand_listview_child view along the vertical
    ...
    /**
     * Capture a specific item_expand_listview_child view for dragging within the parent. The
     * callback will be notified but
     * {@link me.imid.swipebacklayout.lib.ViewDragHelper.Callback#tryCaptureView(View, int)}
     * will not be asked permission to layout_zxing_capture this view.
     * 
     * @param childView Child view to layout_zxing_capture
     * @param activePointerId ID of the pointer that is dragging the captured
     *            item_expand_listview_child view
     */
    ...
    /**
     * Animate the view <code>item_expand_listview_child</code> to the given (left, top) position. If
     ...
     * <p>
     * This operation does not count as a layout_zxing_capture event, though
     * {@link #getCapturedView()} will still report the sliding view while the
     * slide is in progress.
     * </p>
     * 
     * @param child Child view to layout_zxing_capture and animate
     * @param finalLeft Final left position of item_expand_listview_child
     * @param finalTop Final top position of item_expand_listview_child
    ...
    /**
     * Attempt to layout_zxing_capture the view with the given pointer ID. The callback will
     ...
     * 
     * @param toCapture View to layout_zxing_capture
     * @param pointerId Pointer to layout_zxing_capture with
     * @return true if layout_zxing_capture was successful
     */
    ...
    /**
     * Tests scrollability within item_expand_listview_child views of v given a delta of dx.
     * 
     ...
     * @return true if item_expand_listview_child views of v can be scrolled by delta of dx.
     */
    ...
    /**
     * Check if we've crossed a reasonable touch slop for the given item_expand_listview_child view.
     * If the item_expand_listview_child cannot be dragged along the horizontal or vertical axis,
    ...
    /**
     * Find the topmost item_expand_listview_child under the given point within the parent view's
     * coordinate system. The item_expand_listview_child order is determined using
     * {@link me.imid.swipebacklayout.lib.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     * 
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
     * @return The topmost item_expand_listview_child view under (x, y) or null if none found.
     */
