package com.zizhu.skindetection.common.share;
...
public class WechatShareManager {
    ...
    private void initWechatShare(Context context){
        if (mWXApi == null) {
            mWXApi = WXAPIFactory.createWXAPI(context, MConstants.APP_ID, true);
        }
        mWXApi.registerApp(MConstants.APP_ID);
    }
    ...
    public class ShareContentPicture extends ShareContent {
        ...
        private String content;
        public ShareContentPicture(Bitmap pictureResource, String content){
     ...
     * 获取图片分享对象
     */
    public ShareContent getShareContentPicture(Bitmap pictureResource, String content) {
        if (mShareContentPicture == null) {
            mShareContentPicture = new ShareContentPicture(pictureResource, content);
        }
    ...
    private void shareWebPage(ShareContent shareContent, int shareType) {
        ...
        Bitmap thumb = shareContent.getPictureResource();
        if(thumb == null) {
