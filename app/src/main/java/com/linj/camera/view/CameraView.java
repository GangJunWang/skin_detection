	...
	private SurfaceHolder.Callback callback=new SurfaceHolder.Callback() {
		...
		public void surfaceCreated(SurfaceHolder holder) {
			if(getContext() instanceof Activity) {
				if (PermissionUtil.hasPermission((Activity) getContext(), Manifest.permission.CAMERA)) {
					try {
						if(mCamera==null){
							openCamera();
						}
					...
					PermissionUtil.requestPermission((Activity) getContext(), MConstants.OPEN_BLUETOOTH,
